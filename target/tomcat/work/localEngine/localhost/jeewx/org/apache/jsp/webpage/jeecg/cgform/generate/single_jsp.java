  ...
  private boolean _jspx_meth_t_005fformvalid_005f0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_t_005fformvalid_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\t\t\t<td class=\"value\" colspan=\"3\"><select id=\"pageStyle\" name=\"pageStyle\">\n");
        out.write("\t\t\t\t<option value=\"01\" selected=\"selected\">Table风格(form)</option>\n");
        out.write("\t\t\t\t<option value=\"02\">Div风格(form)</option>\n");
